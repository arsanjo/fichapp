...
from utils.nav import sidebar_menu # A importação ainda é necessária para variáveis de estado

# ATENÇÃO: O código principal foi movido para a função 'run_page()'
...
def run_page():
    ...
    # CONFIG / THEME
    # =========================================================
    # Configurações de página (set_page_config) devem ser chamadas
    # apenas uma vez no streamlit_app.py ou no início da execução
    # Vamos manter as configurações de título aqui, pois é onde o conteúdo reside.
